...
namespace Library_test_7.Model
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="LibraryDataContext")]
    ...
    partial void OnAdditionalinfo4Changed();
        ...
        [Column(Name = "title", Storage = "_Title", DbType = "NVarChar(100) NOT NULL", CanBeNull = false)]
        public string Title
        {
            get
            {
		...
		[Column(Name="purchaseprice", Storage="_Purchaseprice", DbType="NVarchar(50)")]
		...
		[Column(Name="currentvalue", Storage="_Currentvalue", DbType="NVarchar(50)")]
		...
		public Editor Editor
		{
			get
			{
				return _Editor.Entity;
			}
			set
			{
				this.SendPropertyChanging();
                _Editor.Entity = value;
    ...
    partial void OnBooksellerIDChanged();
		...
		public Bookseller Bookseller
		{
			get
			{
				return _Bookseller.Entity;
			}
			set
			{
				this.SendPropertyChanging();
                _Bookseller.Entity = value;
                if (value != null)
                {
                    BooksellerID = value.BooksellerID;
                }
    ...
    partial void OnImporterIDChanged();
		...
		public Importer Importer
		{
			get
			{
				return _Importer.Entity;
			}
			set
			{
				this.SendPropertyChanging();
                _Importer.Entity = value;

                if (value != null)
                {
                    ImporterID = value.ImporterID;
                }
    ...
    partial void OnSpecialityChanged();
		...
		[Column(Name="address", Storage="_Address", DbType="NVarChar(20)", CanBeNull=false)]
    ...
    partial void OnEmailChanged();
		...
		[Column(Name="address", Storage="_Address", DbType="NVarChar(50) NOT NULL")]
		public string Address
		{
			get
			{
    ...
    partial void OnEmailChanged();
        ...
        [Column(Name = "importerID", Storage = "_ImporterID", AutoSync = AutoSync.OnInsert, DbType = "Int NOT NULL IDENTITY", IsPrimaryKey = true, IsDbGenerated = true)]
		public int ImporterID
		{
			get
			{
		...
		[Column(Name="name", Storage="_Name", DbType="NVarChar(25)", CanBeNull=false)]
		public string Name
		{
			get
			{
    ...
    partial void OnLocationIDChanged();
    partial void OnRacklableChanging(string value);
    partial void OnRacklableChanged();
    ...
    partial void OnAddtionalinfo2Changed();
        ...
        [Column(Name = "racklable", Storage = "_Racklable", DbType = "NVarChar(10) NOT NULL", CanBeNull=false)]
        public string Racklable
        {
            get
            {
                return this._Racklable;
            }
            set
            {
                if ((this._Racklable != value))
                {
                    this.OnRacklableChanging(value);
                    this.SendPropertyChanging();
                    this._Racklable = value;
                    this.SendPropertyChanged("Racklable");
                    this.OnRacklableChanged();
                }
            }
        }
		...
		public Storagelocation Storagelocation
		{
			get
			{
				return _Storagelocation.Entity;
			}
			set
			{
				this.SendPropertyChanging();
    ...
    partial void OnBookIDChanged();
        ...
        [Column(Name = "text", Storage = "_Text", DbType = "NVarChar(256) NOT NULL", CanBeNull=false)]
		public string Text
		{
			get
			{
    ...
    partial void OnAttribute1Changed();
        ...
        [Column(Name = "shelflable", Storage = "_Shelflable", DbType = "NVarChar(10) NOT NULL", CanBeNull = false)]
